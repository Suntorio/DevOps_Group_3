pipeline {
    ...
    stages {
        ...
        stage('Install ingress and spaceinv in k3s') {
    steps {
        script {
            sh '''
            cd ./projects/k3s_cluster_aws_mine_spaceinv/cluster_init/aws_ingress_setup
        ...
        script {
            sh '''
            cd ./projects/k3s_cluster_aws_mine_spaceinv/cluster_entities/space-inv
            kubectl apply -f mongo-deployment.yaml
            kubectl apply -f spaceinv-deployment.yaml
            '''
            }
        }
    }
